...
class TrialPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        # AB button
        self.ab_button = tk.Button(self, text="Versie A - Versie B", bg="red", command=self.sendVersionAB)
        self.ab_button.grid(row=0, column=0, sticky="s")
        self.ab_text = tk.Label(self, text="of druk op '1'")
        self.ab_text.grid(row=1, column=0, sticky="n")
        self.focus_set()
        self.bind("1", self.sendVersionAB)
        # BC button
        self.bc_button = tk.Button(self, text="Versie B - Versie C", bg="blue", command=self.sendVersionBC)
        self.bc_button.grid(row=0, column=2, sticky="s")
        self.ab_text = tk.Label(self, text="of druk op '2'")
        self.ab_text.grid(row=1, column=2, sticky="n")
        self.focus_set()
        self.bind("2", self.sendVersionBC)
        # Slider
