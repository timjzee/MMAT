...
class TrialPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.next_button.grid(row=1, column=0, sticky="n")
    ...
    def sendToPraat(self, event):
        ...
        subprocess.call([praat_path, "--run", "playStimuli.praat", stimulus_list[self.current_stim], "c_b_a", str(self.erb_shift)])
